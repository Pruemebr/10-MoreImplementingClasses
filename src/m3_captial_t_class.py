...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        vcorner1 = rg.Point(intersection_center.x - (letter_thickness/2), hcorner2.y)
        vcorner2 = rg.Point(intersection_center.x + (letter_thickness/2), hcorner2.y + height)
    ...
    def clone(self):
        ...
        letter_thickness = abs(self.v_rect.corner_1.x - self.v_rect.corner_2.x)
        newT = CapitalT(intersection_center, width, height, letter_thickness)
