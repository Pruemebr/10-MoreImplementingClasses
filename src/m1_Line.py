...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.amountcloned = 0
        self.firststart = self.start.clone()
        self.firstend = self.end.clone()
    ...
    def clone(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        self.amountcloned = self.amountcloned + 1
    ...
    def length(self):
        ...
        # --------------------------------------------------------------
        start = self.start
        distance = start.distance_from(self.end)
        return distance
    ...
    def line_plus(self, other_line):
        ...
        sumstart = self.start.plus(other_line.start)
        sumend = self.end.plus(other_line.end)
        sumline = Line(sumstart, sumend)
        return sumline
    ...
    def line_minus(self, other_line):
        ...
        diffstart = self.start.minus(other_line.start)
        diffend = self.end.minus(other_line.end)
        diffline = Line(diffstart, diffend)
        return diffline
    ...
    def midpoint(self):
        ...
        point = self.start.halfway_to(end)
        return point
